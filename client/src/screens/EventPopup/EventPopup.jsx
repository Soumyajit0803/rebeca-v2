      ...
      <div className={"event-popup"}>
        ...
        <div className="event-desc-img">
          ...
          <div className="event-desc">
            ...
            {eventInfo.register && (
              <>
                <Button innerText={"REGISTER"} onClick={() => register(eventInfo.register)} />
                <>
                  {eventInfo.registrationFee && <p className="fee">(Registration Fee - {eventInfo.registrationFee})</p>}
                </>
              </>
            )}
          </div>
              ...
              return (
                <div className="judge coordinator" key={i}>
                  <div className="img">
                    ...
                    <div className="dp">
                      <img src={`/assets/imgs/team/${coord.name.toLowerCase().replaceAll(" ", "")}.webp`} alt=""></img>
                    </div>
                  </div>
