      ...
      <section className="section-4">
        <div className="row">
          ...
          <div className="contents">
            <p>
              From the pulsating beats of the music to the kaleidoscope of colors lighting up the night sky. Here's to
              reliving those cherished moments and having a blast along the way!
            </p>
            <Button variant={"filled"} innerText={"Create lifelong memories"}></Button>
          </div>
        </div>
