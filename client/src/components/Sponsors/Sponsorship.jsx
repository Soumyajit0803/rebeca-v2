...
const Heading1 = ({ title, subTitle , w}) => {
	return (
		<div className="heading_spon" style={
            {
                width: w,
                position: "relative",
                padding: "4rem 2rem", 
			...
			<div className="title display-font" style={
                {
                    width: "100%",
	                textAlign: "left",
                }
            }>{title}</div>
			{subTitle && <div className="sub-title" style={
                {
                    width: "100%",
	                textAlign: "left",
                }
...
function Sponsorship(){
    ...
    const updateImageSource = () => {
        const newFileName = window.innerWidth > 800 ? "flowChart1" : "flowChart2";
        setFileName(newFileName);

        const newWidth = window.innerWidth > 1260 ? "72%" : "90%";
        setWidthSize(newWidth);

        const newSponsorCategories = newFileName === "flowChart1" ? "sponsorCategories1" : "sponsorCategories2";
            ...
            <div className="sponsor">
                ...
                <section className="section-1">
                    <div className="side-img">
                        <img src="/assets/imgs/sponsorship/clockTower1.png" alt="" />
                    </div>
                ...
                <section className="section-2">
                    <div className="flow-chart">
                        <img src={`/assets/imgs/sponsorship/${fileName}.png`} alt="" />
                    </div>
                ...
                <section className="section-3">
                    ...
                    <div className="sponsor-categories">
                            <img src={`/assets/imgs/sponsorship/${sponsorCategories}.png`} alt="" />
                    </div>
                </section>
                ...
                <section className="section-4">
                    ...
                    <div className="past-sponsor">
                        <img src="/assets/imgs/sponsorship/pastSponsors.png" alt="" />
                    </div>
