...
import Icon, { UploadOutlined, DeleteOutlined, DeleteFilled } from "@ant-design/icons";
...
const EventEditing = ({ memberDetails, onUpdate }) => {
    ...
    return (
        <div style={{ maxWidth: 1200, minHeight: "100vh" }}>
            <span style={{ fontSize: "1.3rem", fontWeight: "500" }}>Find Your Event</span>
            <br />
            <Select
                size="large"
                style={{ width: "100%" }}
                            ...
                            rules={[
                                ...
                                () => ({
                                    validator(_, value) {
                                        ...
                                        return Promise.reject(
                                            new Error("Maximum team size must be positive or >= the minimum team size!")
                                        );
                                    },
                                }),
                            ]}
